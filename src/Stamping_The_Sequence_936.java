 ...
 *
 */
public class Stamping_The_Sequence_936 {

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		Stamping_The_Sequence_936 sts = new Stamping_The_Sequence_936();
		IntStream.of(sts.movesToStamp("abc", "ababc")).forEach(System.out::println);
		IntStream.of(sts.movesToStamp("abc", "abcba")).forEach(System.out::println);
		IntStream.of(sts.movesToStamp("abca", "aabcaca")).forEach(System.out::println);
	}
