...
public class Minimum_Number_of_Refueling_Stops_871 {
	...
	public static void main(String[] args) {
		Minimum_Number_of_Refueling_Stops_871 mnors = new Minimum_Number_of_Refueling_Stops_871();

		System.out
				.println(mnors.minRefuelStops(100, 10, new int[][] { { 10, 60 }, { 20, 30 }, { 30, 30 }, { 60, 40 } }));
		System.out.println(mnors.minRefuelStops(100, 10, new int[][] {}));
		System.out.println(mnors.minRefuelStops(100, 1, new int[][] { { 10, 100 } }));
		System.out.println(mnors.minRefuelStops(999, 1000, new int[][] { { 5, 100 }, { 997, 100 }, { 998, 100 } }));
	}
