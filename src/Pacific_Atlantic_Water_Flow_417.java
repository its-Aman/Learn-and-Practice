...
public class Pacific_Atlantic_Water_Flow_417 {
	...
	public static void main(String[] args) {
		Pacific_Atlantic_Water_Flow_417 pawf = new Pacific_Atlantic_Water_Flow_417();

		long start = System.currentTimeMillis();

		System.out.println(pawf.pacificAtlantic(new int[][] { { 1, 2, 2, 3, 5 }, { 3, 2, 3, 4, 4 }, { 2, 4, 5, 3, 1 },
				{ 6, 7, 1, 4, 5 }, { 5, 1, 1, 2, 4 } }));
...
//		 [7,6,5]
//		]
//		System.out.println(pawf.pacificAtlantic(new int[][] { { 1, 2, 3 }, { 8, 9, 4 }, { 7, 6, 5 } }));
